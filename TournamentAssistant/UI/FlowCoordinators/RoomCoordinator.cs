...
namespace TournamentAssistant.UI.FlowCoordinators
{
    class RoomCoordinator : FlowCoordinatorWithClient
    {
        ...
        protected override void DidActivate(bool firstActivation, bool addedToHierarchy, bool screenSystemEnabling)
        {
            ...
            {
                //Set up UI
                SetTitle("比赛房间", ViewController.AnimationType.None);
            ...
            if (addedToHierarchy)
            {
                ...
                if (TournamentMode)
                {
                    _splashScreen.StatusText = $"正在连接到 \"{Host.Name}\"...";
        ...
        protected override async Task Client_ConnectedToServer(ConnectResponse response)
        {
            ...
            {
                _splashScreen.StatusText = "请等待协调员为你创建比赛...";
        ...
        protected override async Task Client_MatchCreated(Match match)
        {
            ...
            if (TournamentMode && match.AssociatedUsers.ContainsUser(self))
            {
                ...
                UnityMainThreadDispatcher.Instance().Enqueue(() =>
                {
                    ...
                    _splashScreen.StatusText = "比赛已创建。请等待协调员选择比赛歌曲。";
                });
            }
        }
